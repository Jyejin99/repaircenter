...
<head>
    ...
    <link rel="stylesheet" href="/repaircenter/css/login.css">
</head>
    ...
    <main class="form-signin w-100 m-auto">
        <form class="login-form" action="/repaircenter/member/login.php" method="post">
          ...
          <div class="checkbox mb-3">
            <label class="text-white remember">
              <input type="checkbox" value="remember-me"> Remember me
            </label>
          </div>
          <button class="w-100 btn btn-lg btn-primary sign-btn" type="submit">Sign in</button>
